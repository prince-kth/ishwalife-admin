  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-[#0B1120]">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-purple-500/30 rounded-full mix-blend-multiply filter blur-[128px] animate-blob"></div>
        ...
        <div className="absolute -bottom-32 left-20 w-[500px] h-[500px] bg-pink-500/30 rounded-full mix-blend-multiply filter blur-[128px] animate-blob animation-delay-4000"></div>
        
        {/* Star field overlay */}
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,transparent_0%,#0B1120_100%)]"></div>
        <div className="absolute inset-0" style={{ background: 'radial-gradient(white, rgba(255,255,255,.2) 2px, transparent 40px)', backgroundSize: '200px 200px' }}></div>
        <div className="absolute inset-0 opacity-50" style={{ background: 'radial-gradient(white, rgba(255,255,255,.15) 1px, transparent 30px)', backgroundSize: '100px 100px' }}></div>
        
        {/* Vignette effect */}
        <div className="absolute inset-0 bg-gradient-to-br from-transparent via-[#0B1120]/50 to-[#0B1120]/80"></div>
      </div>
