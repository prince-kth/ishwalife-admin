    ...
    `}>
      ...
      <div className="flex-1 p-8">
        <div className="text-center space-y-2 mb-8">
          <h1 className={`text-3xl font-bold tracking-tight bg-gradient-to-r ${themeColors.header} bg-clip-text text-transparent`}>
        ...
        {loadingState.isLoading ? (
          <Card className={`flex-1 bg-gradient-to-br ${themeColors.gradient} ${themeColors.border}`}>
            <CardContent className="h-full flex items-center justify-center">
              <div className="flex flex-col items-center justify-center space-y-8">
                {/* Cosmic Loading Animation */}
                <div className="relative w-32 h-32">
                  <div className={`absolute inset-0 border-2 ${themeColors.loading.ring} rounded-full animate-spin-slow`}></div>
                  <div className={`absolute inset-2 border-2 ${themeColors.loading.ring} rounded-full animate-spin-reverse`}>
                    <div className={`absolute -top-1 left-1/2 w-2 h-2 ${themeColors.loading.dot} rounded-full`}></div>
                    <div className={`absolute top-1/2 -right-1 w-2 h-2 ${themeColors.loading.dot} rounded-full`}></div>
                    <div className={`absolute -bottom-1 left-1/2 w-2 h-2 ${themeColors.loading.dot} rounded-full`}></div>
                  </div>
                  <div className={`absolute inset-4 bg-gradient-to-br ${themeColors.gradient} rounded-full animate-pulse`}></div>
                      ...
                      <div
                        ...
                        className={`w-2 h-2 rounded-full transition-all duration-500 ${
                          step <= loadingState.step
                            ? themeColors.text + ' scale-100'
                            : themeColors.text + '/30 scale-75'
                        }`}
                      />
                    ))}
                  </div>
          ...
          <div className="container mx-auto max-w-7xl">
            {step === 'user-type' && (
              ...
              >
                ...
                >
                  <CardHeader>
                    <User className={`w-12 h-12 ${themeColors.text} mb-4`} />
                ...
                >
                  <CardHeader>
                    <Search className={`w-12 h-12 ${themeColors.text} mb-4`} />
                  ...
                  <Tabs defaultValue="personal" className="flex-1 flex flex-col">
                    ...
                    <div className={`flex justify-end gap-3 mt-3 sticky bottom-0  `}>
                      <Button
                        type="submit"
                        size="sm"
                        className={`min-w-[120px] ${themeColors.button}`}
