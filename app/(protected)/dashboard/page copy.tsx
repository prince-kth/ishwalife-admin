              ...
              <BarChart data={chartData}>
                ...
                <defs>
                  <linearGradient id="colorGradient" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="0%" stopColor={`var(--${accentColor}-600)`} />
                    <stop offset="100%" stopColor={`var(--${accentColor}-700)`} />
                  </linearGradient>
                </defs>
                <Bar 
                  dataKey="value" 
                  fill="url(#colorGradient)"
                  className={`bg-gradient-to-b ${getThemeColors().bar}`}
                />
              </BarChart>
            </ResponsiveContainer>
          )}
